...
<!-- Mirrored from html.xpeedstudio.com/upturn/blog-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Dec 2019 17:07:24 GMT -->
<head>
		<meta charset="utf-8">
		<meta http-equiv="x-ua-compatible" content="ie=edge">
		<title>DM Setu -Blog List</title>
        ...
        <div class="row">
            <div class="col-md-6">
                <ul class="xs-top-bar-info">
                    <li>
                        <p><a href="tel:+1%20(254)%854-8569"><i class="icon icon-phone3"></i>+91
                            9373 615 614</a></p>
                    </li>
                    <li> <a href="mailto:info@dmsetu.com"><i class="icon icon-email"></i>info@dmsetu.com</a>
                    </li>
                </ul>
            </div>
            <div class="col-md-6">
...
<!--                                    </li>-->
<!--                                    <li class="single-menu-item">-->
<!--                                        <a href="index.html"><i class="icon icon-home2"></i> Home 2</a>-->
<!--                                    </li>-->
<!--                                    <li class="single-menu-item">-->
<!--                                        <a href="index.html"><i class="icon icon-home2"></i> Home 3</a>-->
<!--                                    </li>-->
<!--                                    <li class="single-menu-item">-->
<!--                                        <a href="index.html"><i class="icon icon-home3"></i> One Page Style</a>-->
<!--                                    </li>-->
<!--                                    <li class="single-menu-item">-->
<!--                                        <a href="index.html"><i class="icon icon-home3"></i> One Page Style Two</a>-->
<!--                                    </li>-->
<!--                                </ul>-->
                            </li>
                            <li><a href="#">ABOUT</a>
                                <div class="megamenu-panel xs-icon-menu">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="single-menu-item"> <a href="about.html"><i class="icon icon-briefcase"></i>About</a>
                                            </div>
                                            <div class="single-menu-item"> <a href="case-studies.html"><i class="icon icon-line-chart"></i>Case Studies</a>
                                            </div>
                                            <div class="single-menu-item"> <a href="faq.html"><i class="icon icon-question-circle"></i>FAQ</a>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="single-menu-item"> <a href="team.html"><i class="icon icon-folder2"></i>Team</a>
                                            </div>
                                            <div class="single-menu-item"> <a href="shop.html"><i class="icon icon-shopping-cart-1"></i>Shop</a>
                                            </div>

                                        </div>
                                        <div class="col-lg-4">

                                            <div class="single-menu-item"> <a href="pricing.html"><i class="icon icon-direction"></i>Pricing</a>
                                            </div>
                                            <div class="single-menu-item"> <a href="testimonial.html"><i class="icon icon-users"></i>Testimonial</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="blog-post-lists">
                        ...
                        <div class="post-body">
                            <div class="entry-header">
                                ...
                                <div class="entry-content">
                                    <p><?php echo stripslashes($pageDetails["page_desc"]);?></p>
                                </div>
                    ...
                    </div><!-- .post-list .format-video END -->
                    ...
                    </div><!-- .post-list .format-gallery END -->
                    ...
                    </div><!-- .post-list .format-audio END -->
                    ...
                    </div><!-- .post-list .format-text END -->
                </div><!-- .blog-post-lists END -->
                <!-- pagination -->
                <ul class="pagination">
        ...
        <div class="container">
            <div class="footer-top-area">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="footer-logo"> <a href="index.html"> <img src="assets/images/logo.png" alt="">
                        </a> </div>
                        <!-- .footer-logo END -->
                    </div>
                    ...
                    <div class="col-md-8">
                        <ul class="address-info-list list-inline">
                            <li>
                                <div class="address-icon"> <img src="assets/images/pin.png" alt="">
                                </div>
                                <div class="address-info"><a href="#">1010,
                                    Near AIMS, Aundh<br>
                                    Pune-07</a></div>
                            </li>
                            <li>
                                <div class="address-icon"><img src="assets/images/massage.png" alt=""></div>
                                <div class="address-info"><a href="tel:9373-615-614">+91 9373 615 614</a>
                                    (Mon-Sat; 9am-7pm) <br>
                                    <a href="mailto:info@dmsetu.com">info@dmsetu.com</a></div>
                            </li>
                        </ul>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-widget">
                            ...
                            <ul class="articles-list">
                                ...
                                <li> <a class="entry-title" href="blog-single.html">Twice profit than
                                    before you ever</a> <span class="entry-meta"><i class="icon icon-clock"></i>
              January 14, 2020</span> </li>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-widget">
                            ...
                            <form action="#" class="contact-form" method="post">
                                ...
                                <input type="numeric" name="mobile number" placeholder="Mobile" class="form-control">
					...
					<div class="row">
						<div class="col-md-6">
                            <div class="copyright-text">
                                <p>Copyright &copy; 2020, All Right Reserved <a href="#"><em>DM Setu.</em></a> | Developed By <a href="http://www.dnyano.com"><em>Dnyano.</em></a></p>
...
<!-- Mirrored from html.xpeedstudio.com/upturn/blog-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Dec 2019 17:07:25 GMT -->
</html>